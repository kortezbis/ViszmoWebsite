...
function PaperPlane2({title = 'badge 13', fill = 'currentColor', ...props}: IconProps) {
	return (
		<svg height="12" width="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" fill={fill} {...props}>
	<title>{title}</title>
	<g fill={fill}>
