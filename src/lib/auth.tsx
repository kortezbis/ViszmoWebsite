        ...
        <div className="relative">
            ...
            {open && (
                <>
                    ...
                    <div className="absolute right-0 top-11 z-50 w-48 bg-white rounded-2xl border border-slate-200 shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-100">
