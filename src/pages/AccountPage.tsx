                        ...
                        <div className="p-8 md:p-12">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                <div>
                                    ...
                                    <div className="text-base font-semibold text-slate-900">kevjohnson032@gmail.com</div>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-slate-500 mb-2 block">Name</label>
                                    <div className="text-base font-semibold text-slate-900">Kortez</div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center justify-between p-4 rounded-2xl border border-slate-200 bg-slate-50/50">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-slate-500 font-medium">kevjohnson032@gmail.com</div>
                                    </div>
                                </div>
